...
function answer() {
    ...
    var input_message_for_answer = document.getElementById("saver").textContent;
    ...
    else if (input_message_for_answer.toLowerCase().includes("мое имя")){new_answer.innerHTML = get_user_name(input_message_for_answer);}
    else if (input_message_for_answer.toLowerCase().includes("пока") |
            input_message_for_answer.toLowerCase().includes("до свидания")){new_answer.innerHTML = answer_bye();}
    else if (input_message_for_answer.toLowerCase().includes("прощай")){new_answer.innerHTML = answer_n_bye();}
    else if ((input_message_for_answer.toLowerCase().includes("тебя") & input_message_for_answer.includes("зовут")) | 
             (input_message_for_answer.toLowerCase().includes("твое") & input_message_for_answer.toLowerCase().includes("имя"))){new_answer.innerHTML = answer_ag_name();}
    else if (input_message_for_answer.toLowerCase().includes("кто") & input_message_for_answer.includes("ты")){new_answer.innerHTML = answer_who();}
    else if (input_message_for_answer.toLowerCase().includes("как") & (input_message_for_answer.includes("дела") | 
             input_message_for_answer.toLowerCase().includes("дели"))){new_answer.innerHTML = answer_hayou();}
    else if ((input_message_for_answer.toLowerCase().includes("что") & input_message_for_answer.includes("делаешь")) | 
             (input_message_for_answer.toLowerCase().includes("чем") & input_message_for_answer.toLowerCase().includes("занимаешся"))){new_answer.innerHTML = answer_ag_doing();}
    else if (input_message_for_answer.toLowerCase().includes("доброе утро")){new_answer.innerHTML = answer_good_m();}
    else if (input_message_for_answer.toLowerCase().includes("спать") |
            (input_message_for_answer.toLowerCase().includes("спокойной") |
            input_message_for_answer.toLowerCase().includes("доброй")) & input_message_for_answer.toLowerCase().includes("ночи")){new_answer.innerHTML = answer_good_n();}
